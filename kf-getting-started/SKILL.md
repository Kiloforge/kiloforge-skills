...
5. Create tracks directory with empty state files:
   ...
   - `.agent/kf/bin/*` — install all CLI tools from `$SKILL_DIR/../kf-bin/scripts/` (kf-primary-branch, kf-track, kf-track-content, kf-merge-lock, kf-worktree-env)
