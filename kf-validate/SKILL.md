...
# CLI tools (installed globally at ~/.kf/bin/)
[ -x ~/.kf/bin/kf-primary-branch.py ] && echo "PASS: kf-primary-branch exists" || echo "FAIL: kf-primary-branch missing"
[ -x ~/.kf/bin/kf-track.py ] && echo "PASS: kf-track exists" || echo "FAIL: kf-track missing"
[ -x ~/.kf/bin/kf-track-content.py ] && echo "PASS: kf-track-content exists" || echo "FAIL: kf-track-content missing"
[ -x ~/.kf/bin/kf-merge.py ] && echo "PASS: kf-merge exists" || echo "FAIL: kf-merge missing"
[ -x ~/.kf/bin/kf-merge-lock.py ] && echo "PASS: kf-merge-lock exists" || echo "FAIL: kf-merge-lock missing"
[ -x ~/.kf/bin/kf-worktree-env.py ] && echo "PASS: kf-worktree-env exists" || echo "FAIL: kf-worktree-env missing"
```
